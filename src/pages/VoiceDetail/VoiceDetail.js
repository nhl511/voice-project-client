    ...
    return (
        <div className="voicedetail-card">
            ...
            <div className="voicedetail-info">
                <span style={{ fontSize: 22 }}>Trần Thành Công</span><br />
                <span>(100 người theo dõi)</span><br />
                <span style={{ color: 'black', fontWeight: 400 }}>11 tháng 7 lúc 12:40</span>
            </div>
            ...
            <div className="voicedetail-detail">
                ...
                <div className="voicedetail-detail-info ">
                    ...
                    <div className="voicedetail-show">
                        ...
                        <div>
                            <input type="checkbox" />
                            <label className="voicedetail-label">Tươi mới <br /></label>
                        </div>
                        <div>
                            <input type="checkbox" />
                ...
                <div className="voicedetail-detail-info voicedetail-show">
                    <span>Tính chất phù hợp</span><br />
                    <div className="voicedetail-show">
                        <div>
                            <input type="checkbox" />
                        ...
                        <div>
                            <input type="checkbox" />
                            <label className="voicedetail-label">Review phim <br /></label>
                        </div>
                        <div>
                            <input type="checkbox" />
